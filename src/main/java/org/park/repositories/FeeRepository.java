...
""")
    Optional<Fee> getFeeByParameters(@Param("vehicleType") VehicleType vehicleType,@Param("parkingSlotType") ParkingSlotType parkingSlotType,@Param("feeType") FeeType feeType);
}
